...
Примеры строк, которые не должны находиться: hello, "bar", 'abc
...
Примеры строк, которые не должны находиться: 1hello, 5rter
...
Примеры строк, которые не должны находиться: A123BC77, 123АВС77, А12ВС777
...
Для задачи 3 блока необходимо реализовать алгоритм поиска подстрок в тексте, перейдя к графу автомата.  
